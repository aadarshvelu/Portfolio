    ...
    return (
        <div className="grid-container">
           <div className="topBar">
             <motion.img src={require('../../assets/logo.gif')} alt="img" className={"min-logo"} initial={{ y: '-50vw' }} animate={{ y: 0 }} transition={{ type: 'spring', mass: 1, ease: 'backOut' }} whileHover={{ scale: 1.2 }} drag dragElastic={1} dragConstraints={{ left: 0, right: 0, top: 0, bottom: 0 }}/>
           ...
           <motion.img src={design} alt="img" className={"design1 img img-thumbnail"} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ ease: 'easeOut' }} />
           ...
           <motion.img src={avatar} alt="img" className={"avatar1 img-thumbnail"} initial={{ x: '-20vw' }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 1.5, ease: 'linear' }} whileHover={{ opacity: 0 }} />
