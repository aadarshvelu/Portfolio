...
// avatar 
import avatar from '../../assets/avatar/ava5.svg';
                    ...
                    <div className="section1">
                        <motion.div className="item3" whileHover={{ scale: 1.2 }} transition={{ type: 'spring', ease: 'easeOut' }}>                            
                            <a href="http://mypass-webapp.herokuapp.com/" target="_blank"  rel="noopener noreferrer">
                                <motion.img src={project1} initial={{ y: '-370vw', rotate: '10deg' }} animate={{ y: 0 }} transition={{ type: 'spring', duration: 2, mass: 0.5, ease: 'easeOut', delay: 0.8 }} alt="img" className={"p1 img img-thumbnail"} />
                            </a>
                        </motion.div>
                    </div>
                    <div className="section2">
                        <motion.div className="item2" whileHover={{ scale: 1.2 }} transition={{ type: 'spring', ease: 'easeOut' }}>
                            <a href="https://dsavisually.netlify.app/" target="_blank"  rel="noopener noreferrer">
                                <motion.img initial={{ y: '-270vw' }} animate={{ y: 0, rotate: '-15deg' }} transition={{ type: 'spring', mass: 0.5, duration: 2, ease: 'easeOut', delay: 0.8 }} src={project3} alt="img" className={"p3 img img-thumbnail"} />
                            </a>
                        </motion.div>
                        <motion.div className="item1" whileHover={{ scale: 1.2 }} transition={{ type: 'spring', ease: 'easeOut' }}>
                            <a href="http://listenify.herokuapp.com/" target="_blank"  rel="noopener noreferrer">                            
                                <motion.img initial={{ y: '-270vw' }} animate={{ y: 0, rotate: '-20deg' }} transition={{ type: 'spring', mass: 0.5, duration: 2, ease: 'easeOut', delay: 0.8 }} src={project2} alt="img" className={"p2 img img-thumbnail"} />
                            </a>
                        </motion.div>
                    </div>
                </div>
                <div className="getResume">
                    ...
                    <div className="ava3Base">
                        <a href={Resume} download={"Aadarsh's_Resume"} rel="noopener noreferrer" target="_blank">
                            <motion.img className="avatar3 img img-thumbnail" src={avatar} alt="img" animate={{ y: [-15, 15, -15] }} transition={{ duration: 2, ease: "easeInOut", loop: Infinity, }}/>
                        </a>
                    </div>
