...
function DroneUnit({ label, cardType, index, startPhase, flyFrom, flyControl }: DroneUnitProps) {
    ...
    <group ref={groupRef}>
      ...
      <mesh
        ...
        onPointerEnter={() => {
          ...
          // cursor handled by CustomCursor
        }}
        onPointerLeave={() => {
