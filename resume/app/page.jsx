    ...
    <aside className="control-pane">
      ...
      <div className="cp-scroll">
        ...
        <section className="cp-group">
          ...
          />
          <Field
            label="Portfolio URL (also used by the ← Portfolio link above)"
    ...
    <div className="resume-app">
      ...
      <main className="stage">
        <div className="stage-toolbar">
          <a className="resume-btn resume-btn--ghost" href={data.meta?.portfolioUrl || "/"}>
            ← Portfolio
          </a>
          ...
          {/* Print-then-upload: after Download PDF above saves a file locally
              via the browser's own print dialog, pick that same file here to
              publish it — this is what the public /download link serves. */}
          <input
            ref={fileInputRef}
            type="file"
